...
public class C02_TryCatch {
    public static void main(String[] args) {
        /*
            Try-catch bloklarinin amaci riski 0 yapmak degil kodu iyi analiz yapip,
            java'nin cozemeyecegi durumlarda ne yapmasini istedigimizi javaya soylemektir.
            Java try blogunda basedemeyecegi bir sorunla karsilasirsa,
            siz o sorunu deklare edinceye kadar yani catch() satirina kadar calismayi durdurur.
        ...
        try {
            ...
            e.printStackTrace(); //Hata sebebinin ne oldugunu yazdirmaya yariyor.
        }
