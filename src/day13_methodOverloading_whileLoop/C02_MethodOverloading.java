...
public class C02_MethodOverloading {
    public static void main(String[] args) {
        ...
        // Eger sectigimiz isimde birden fazla method varsa
        // buna overloading denir
        // ve ayni isimdeki method'lardan hangisinin calisacagina
        ...
        /*
           ...
           ve ayni data turunden parametre sayisi ile 2 method olusturmaniza
            izin vermez
           1- ismini degistirebiliriz, ancak bu durumda overloading olmaz
              overloading ayni isimde ama farkli isleve sahip methodlar
              olusturmak demektir
           2- parametre sayisini degistirebiliriz
           3- ayni sayida parametre yazip, parametrelerin data turunu
           degistirebiliriz
              veya farkli data turundeki parametrelerin yerini
              degistirebiliriz
         */
